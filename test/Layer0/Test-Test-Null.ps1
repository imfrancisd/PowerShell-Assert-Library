...
& {
    $testDescription = 'Test-Null help'
...
& {
    $testDescription = 'Test-Null parameters'
...
& {
    $testDescription = 'Test-Null with Boolean $true'
...
& {
    $testDescription = 'Test-Null with Boolean $false'
...
& {
    $testDescription = 'Test-Null with $null'
...
& {
    $testDescription = 'Test-Null with Non-Boolean that is convertible to $true'
...
& {
    $testDescription = 'Test-Null with Non-Boolean that is convertible to $false'
