...
& {
    $testDescription = 'Test-True help'
...
& {
    $testDescription = 'Test-True parameters'
...
& {
    $testDescription = 'Test-True with Boolean $true'
...
& {
    $testDescription = 'Test-True with Boolean $false'
...
& {
    $testDescription = 'Test-True with $null'
...
& {
    $testDescription = 'Test-True with Non-Boolean that is convertible to $true'
...
& {
    $testDescription = 'Test-True with Non-Boolean that is convertible to $false'
