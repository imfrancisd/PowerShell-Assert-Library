...
& {
    $testDescription = 'Test-NotNull help'
...
& {
    $testDescription = 'Test-NotNull parameters'
...
& {
    $testDescription = 'Test-NotNull with Boolean $true'
...
& {
    $testDescription = 'Test-NotNull with Boolean $false'
...
& {
    $testDescription = 'Test-NotNull with $null'
...
& {
    $testDescription = 'Test-NotNull with Non-Boolean that is convertible to $true'
...
& {
    $testDescription = 'Test-NotNull with Non-Boolean that is convertible to $false'
