...
& {
    $testDescription = 'Test-False help'
...
& {
    $testDescription = 'Test-False parameters'
...
& {
    $testDescription = 'Test-False with Boolean $true'
...
& {
    $testDescription = 'Test-False with Boolean $false'
...
& {
    $testDescription = 'Test-False with $null'
...
& {
    $testDescription = 'Test-False with Non-Boolean that is convertible to $true'
...
& {
    $testDescription = 'Test-False with Non-Boolean that is convertible to $false'
