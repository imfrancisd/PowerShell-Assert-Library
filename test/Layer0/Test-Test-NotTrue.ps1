...
& {
    $testDescription = 'Test-NotTrue help'
...
& {
    $testDescription = 'Test-NotTrue parameters'
...
& {
    $testDescription = 'Test-NotTrue with Boolean $true'
...
& {
    $testDescription = 'Test-NotTrue with Boolean $false'
...
& {
    $testDescription = 'Test-NotTrue with $null'
...
& {
    $testDescription = 'Test-NotTrue with Non-Boolean that is convertible to $true'
...
& {
    $testDescription = 'Test-NotTrue with Non-Boolean that is convertible to $false'
