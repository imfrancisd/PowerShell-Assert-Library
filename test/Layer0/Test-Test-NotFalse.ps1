...
& {
    $testDescription = 'Test-NotFalse help'
...
& {
    $testDescription = 'Test-NotFalse parameters'
...
& {
    $testDescription = 'Test-NotFalse with Boolean $true'
...
& {
    $testDescription = 'Test-NotFalse with Boolean $false'
...
& {
    $testDescription = 'Test-NotFalse with $null'
...
& {
    $testDescription = 'Test-NotFalse with Non-Boolean that is convertible to $true'
...
& {
    $testDescription = 'Test-NotFalse with Non-Boolean that is convertible to $false'
