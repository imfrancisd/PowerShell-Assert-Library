...
& {
    $testDescription = 'Assert-True help'
...
& {
    $testDescription = 'Assert-True parameters'
...
& {
    $testDescription = 'Assert-True with Boolean $true'
...
& {
    $testDescription = 'Assert-True with Boolean $false'
...
& {
    $testDescription = 'Assert-True with $null'
...
& {
    $testDescription = 'Assert-True with Non-Boolean that is convertible to $true'
...
& {
    $testDescription = 'Assert-True with Non-Boolean that is convertible to $false'
