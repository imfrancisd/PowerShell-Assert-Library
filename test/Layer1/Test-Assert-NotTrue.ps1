...
& {
    Write-Verbose -Message 'Test Assert-NotTrue parameters' -Verbose:$headerVerbosity

    $message = 'Assert-NotTrue failed parameter tests.'

    $paramSets = @((Get-Command -Name Assert-NotTrue).ParameterSets)
