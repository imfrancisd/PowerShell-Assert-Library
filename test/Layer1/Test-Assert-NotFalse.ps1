...
& {
    Write-Verbose -Message 'Test Assert-NotFalse parameters' -Verbose:$headerVerbosity

    $message = 'Assert-NotFalse failed parameter tests.'

    $paramSets = @((Get-Command -Name Assert-NotFalse).ParameterSets)
