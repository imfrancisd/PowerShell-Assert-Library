...
& {
    $testDescription = 'Assert-NotFalse help'
...
& {
    $testDescription = 'Assert-NotFalse parameters'
...
& {
    $testDescription = 'Assert-NotFalse with Boolean $true'
...
& {
    $testDescription = 'Assert-NotFalse with Boolean $false'
...
& {
    $testDescription = 'Assert-NotFalse with $null'
...
& {
    $testDescription = 'Assert-NotFalse with Non-Boolean that is convertible to $true'
...
& {
    $testDescription = 'Assert-NotFalse with Non-Boolean that is convertible to $false'
