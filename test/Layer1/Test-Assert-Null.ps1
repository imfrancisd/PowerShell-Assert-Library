...
& {
    $testDescription = 'Assert-Null help'
...
& {
    $testDescription = 'Assert-Null parameters'
...
& {
    $testDescription = 'Assert-Null with Boolean $true'
...
& {
    $testDescription = 'Assert-Null with Boolean $false'
...
& {
    $testDescription = 'Assert-Null with $null'
...
& {
    $testDescription = 'Assert-Null with Non-Boolean that is convertible to $true'
...
& {
    $testDescription = 'Assert-Null with Non-Boolean that is convertible to $false'
