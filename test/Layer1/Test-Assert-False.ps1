...
& {
    $testDescription = 'Assert-False help'
...
& {
    $testDescription = 'Assert-False parameters'
...
& {
    $testDescription = 'Assert-False with Boolean $true'
...
& {
    $testDescription = 'Assert-False with Boolean $false'
...
& {
    $testDescription = 'Assert-False with $null'
...
& {
    $testDescription = 'Assert-False with Non-Boolean that is convertible to $true'
...
& {
    $testDescription = 'Assert-False with Non-Boolean that is convertible to $false'
