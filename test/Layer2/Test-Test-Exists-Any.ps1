...
.\Test-Test-Exists-Any.ps1 -logger $simpleLogger
...
.\Test-Test-Exists-Any.ps1 -logger $customLogger
...
& {
    $test = newTestLogEntry 'Test-Exists -Quantity Any with singleton containing $true'
    $pass = $false
    try {
        $test.Data.out = $out = @()
        $test.Data.in  = @{collection = @($true); predicate = $predicates.Identity;}
        $test.Data.err = try {Test-Exists -Quantity Any $test.Data.in.collection $test.Data.in.predicate -OutVariable out | Out-Null} catch {$_}
        $test.Data.out = $out
...
& {
    $test = newTestLogEntry 'Test-Exists -Quantity Any with singleton containing $false'
    $pass = $false
    try {
        $test.Data.out = $out = @()
...
& {
    $test = newTestLogEntry 'Test-Exists -Quantity Any with singleton containing $null'
    $pass = $false
    try {
        $test.Data.out = $out = @()
...
& {
    $testDescription = 'Test-Exists -Quantity Any with singleton containing Non-Boolean that is convertible to $true'
...
& {
    $testDescription = 'Test-Exists -Quantity Any with singleton containing Non-Boolean that is convertible to $false'
...
& {
    $test = newTestLogEntry 'Test-Exists -Quantity Any with tuple containing $true'
    $pass = $false
    try {
        $test.Data.out = $out = @()
...
& {
    $test = newTestLogEntry 'Test-Exists -Quantity Any with tuple containing $false'
    $pass = $false
    try {
        $test.Data.out = $out = @()
...
& {
    $test = newTestLogEntry 'Test-Exists -Quantity Any with tuple containing $null'
    $pass = $false
    try {
        $test.Data.out = $out = @()
...
& {
    $testDescription = 'Test-Exists -Quantity Any with tuple containing Non-Boolean that is convertible to $true'
...
& {
    $testDescription = 'Test-Exists -Quantity Any with tuple containing Non-Boolean that is convertible to $false'
...
& {
    $testDescription = 'Test-Exists -Quantity Any with null predicate'
...
& {
    $testDescription = 'Test-Exists -Quantity Any with null collection'
...
& {
    $testDescription = 'Test-Exists -Quantity Any with collections containing null'
...
& {
    $testDescription = 'Test-Exists -Quantity Any with empty collection and true predicate'
...
& {
    $testDescription = 'Test-Exists -Quantity Any with empty collection and false predicate'
...
& {
    $testDescription = 'Test-Exists -Quantity Any with empty collection and identity predicate'
...
& {
    $testDescription = 'Test-Exists -Quantity Any with empty collection and error predicate'
...
& {
    $testDescription = 'Test-Exists -Quantity Any with scalar and true predicate'
...
& {
    $testDescription = 'Test-Exists -Quantity Any with scalar and false predicate'
...
& {
    $testDescription = 'Test-Exists -Quantity Any with scalar and identity predicate'
...
& {
    $testDescription = 'Test-Exists -Quantity Any with scalar and error predicate'
...
& {
    $test = newTestLogEntry 'Test-Exists -Quantity Any with quadruple and a predicate that throws on the first element'
    $pass = $false
    try {
        $test.Data.out = $out = @()
...
& {
    $test = newTestLogEntry 'Test-Exists -Quantity Any with quadruple and a predicate that throws on the second element'
    $pass = $false
    try {
        $test.Data.out = $out = @()
...
& {
    $test = newTestLogEntry 'Test-Exists -Quantity Any with quadruple and a predicate that throws on the third element'
    $pass = $false
    try {
        $test.Data.out = $out = @()
...
& {
    $test = newTestLogEntry 'Test-Exists -Quantity Any with quadruple and a predicate that throws on the fourth element'
    $pass = $false
    try {
        $test.Data.out = $out = @()
...
& {
    $test = newTestLogEntry 'Test-Exists -Quantity Any with quadruple and a predicate that throws on the fifth element'
    $pass = $false
    try {
        $test.Data.out = $out = @()
...
& {
    ...
    foreach ($i in @(0, 6, -1)) {
        $test = newTestLogEntry 'Test-Exists -Quantity Any normal fail'
        $pass = $false
        try {
            $test.Data.out = $out = @()
            $test.Data.in = @{
            ...
            $test.Data.err = try {Test-Exists -Quantity Any $test.Data.in.inputObject $test.Data.in.predicate -OutVariable out | Out-Null} catch {$_}
            $test.Data.out = $out
...
& {
    ...
    foreach ($i in @(1..4)) {
        $test = newTestLogEntry 'Test-Exists -Quantity Any early pass'
        $pass = $false
        try {
            $test.Data.out = $out = @()
            $test.Data.in = @{
...
& {
    ...
    $test = newTestLogEntry 'Test-Exists -Quantity Any with a predicate that contains "break" outside of a loop'
    $pass = $false
    try {
        $test.Data.out = $out = @()
        $test.Data.in = @{
...
& {
    $test = newTestLogEntry 'Test-Exists -Quantity Any with an arraylist that has its .NET members overriden'
    $pass = $false
...
& {
    $test = newTestLogEntry 'Test-Exists -Quantity Any with a hashtable that has its .NET members overriden'
    $pass = $false
