...
.\Test-Test-NotExists-Multiple.ps1 -logger $simpleLogger
...
.\Test-Test-NotExists-Multiple.ps1 -logger $customLogger
...
& {
    $test = newTestLogEntry 'Test-NotExists -Quantity Multiple with singleton containing $true'
    $pass = $false
    try {
        $test.Data.out = $out = @()
        $test.Data.in  = @{collection = @($true); predicate = $predicates.Identity;}
        $test.Data.err = try {Test-NotExists -Quantity Multiple $test.Data.in.collection $test.Data.in.predicate -OutVariable out | Out-Null} catch {$_}
        $test.Data.out = $out
...
& {
    $test = newTestLogEntry 'Test-NotExists -Quantity Multiple with singleton containing $false'
    $pass = $false
    try {
        $test.Data.out = $out = @()
...
& {
    $test = newTestLogEntry 'Test-NotExists -Quantity Multiple with singleton containing $null'
    $pass = $false
    try {
        $test.Data.out = $out = @()
...
& {
    $testDescription = 'Test-NotExists -Quantity Multiple with singleton containing Non-Boolean that is convertible to $true'
...
& {
    $testDescription = 'Test-NotExists -Quantity Multiple with singleton containing Non-Boolean that is convertible to $false'
...
& {
    $test = newTestLogEntry 'Test-NotExists -Quantity Multiple with tuple containing $true'
    $pass = $false
    try {
        $test.Data.out = $out = @()
...
& {
    $test = newTestLogEntry 'Test-NotExists -Quantity Multiple with tuple containing $false'
    $pass = $false
    try {
        $test.Data.out = $out = @()
...
& {
    $test = newTestLogEntry 'Test-NotExists -Quantity Multiple with tuple containing $null'
    $pass = $false
    try {
        $test.Data.out = $out = @()
...
& {
    $testDescription = 'Test-NotExists -Quantity Multiple with tuple containing Non-Boolean that is convertible to $true'
...
& {
    $testDescription = 'Test-NotExists -Quantity Multiple with tuple containing Non-Boolean that is convertible to $false'
...
& {
    $testDescription = 'Test-NotExists -Quantity Multiple with null predicate'
...
& {
    $testDescription = 'Test-NotExists -Quantity Multiple with null collection'
...
& {
    $testDescription = 'Test-NotExists -Quantity Multiple with collections containing null'
...
& {
    $testDescription = 'Test-NotExists -Quantity Multiple with empty collection and true predicate'
...
& {
    $testDescription = 'Test-NotExists -Quantity Multiple with empty collection and false predicate'
...
& {
    $testDescription = 'Test-NotExists -Quantity Multiple with empty collection and identity predicate'
...
& {
    $testDescription = 'Test-NotExists -Quantity Multiple with empty collection and error predicate'
...
& {
    $testDescription = 'Test-NotExists -Quantity Multiple with scalar and true predicate'
...
& {
    $testDescription = 'Test-NotExists -Quantity Multiple with scalar and false predicate'
...
& {
    $testDescription = 'Test-NotExists -Quantity Multiple with scalar and identity predicate'
...
& {
    $testDescription = 'Test-NotExists -Quantity Multiple with scalar and error predicate'
...
& {
    $test = newTestLogEntry 'Test-NotExists -Quantity Multiple with quadruple and a predicate that throws on the first element'
    $pass = $false
    try {
        $test.Data.out = $out = @()
...
& {
    $test = newTestLogEntry 'Test-NotExists -Quantity Multiple with quadruple and a predicate that throws on the second element'
    $pass = $false
    try {
        $test.Data.out = $out = @()
...
& {
    $test = newTestLogEntry 'Test-NotExists -Quantity Multiple with quadruple and a predicate that throws on the third element'
    $pass = $false
    try {
        $test.Data.out = $out = @()
...
& {
    $test = newTestLogEntry 'Test-NotExists -Quantity Multiple with quadruple and a predicate that throws on the fourth element'
    $pass = $false
    try {
        $test.Data.out = $out = @()
...
& {
    $test = newTestLogEntry 'Test-NotExists -Quantity Multiple with quadruple and a predicate that throws on the fifth element'
    $pass = $false
    try {
        $test.Data.out = $out = @()
...
& {
    ...
    foreach ($i in @(0, 6, -1)) {
        $test = newTestLogEntry 'Test-NotExists -Quantity Multiple normal pass'
        $pass = $false
        try {
            $test.Data.out = $out = @()
            $test.Data.in = @{
            ...
            $test.Data.err = try {Test-NotExists -Quantity Multiple $test.Data.in.inputObject $test.Data.in.predicate -OutVariable out | Out-Null} catch {$_}
            $test.Data.out = $out
...
& {
    ...
    foreach ($i in @(1..4)) {
        $test = newTestLogEntry 'Test-NotExists -Quantity Multiple early fail'
        $pass = $false
        try {
            $test.Data.out = $out = @()
            $test.Data.in = @{
...
& {
    ...
    $test = newTestLogEntry 'Test-NotExists -Quantity Multiple with a predicate that contains "break" outside of a loop'
    $pass = $false
    try {
        $test.Data.out = $out = @()
        $test.Data.in = @{
...
& {
    $test = newTestLogEntry 'Test-NotExists -Quantity Multiple with an arraylist that has its .NET members overriden'
    $pass = $false
...
& {
    $test = newTestLogEntry 'Test-NotExists -Quantity Multiple with a hashtable that has its .NET members overriden'
    $pass = $false
